...
@Component({
  selector: 'MarketNew-home',
  templateUrl: './MarketNew-home.component.html',
  styleUrls: ['./MarketNew-home.component.scss']
})
export class MarketNewHomeComponent implements AfterViewInit {
