...
@Component({
  selector: 'DailyStockPrice-home',
  templateUrl: './DailyStockPrice-home.component.html',
  styleUrls: ['./DailyStockPrice-home.component.scss']
})
export class DailyStockPriceHomeComponent implements AfterViewInit {
