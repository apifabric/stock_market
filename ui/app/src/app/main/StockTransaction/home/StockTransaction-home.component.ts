...
@Component({
  selector: 'StockTransaction-home',
  templateUrl: './StockTransaction-home.component.html',
  styleUrls: ['./StockTransaction-home.component.scss']
})
export class StockTransactionHomeComponent implements AfterViewInit {
