...
@Component({
  selector: 'SectorPerformance-home',
  templateUrl: './SectorPerformance-home.component.html',
  styleUrls: ['./SectorPerformance-home.component.scss']
})
export class SectorPerformanceHomeComponent implements AfterViewInit {
